...
require(geepack)
summary(geese(HamD ~ factor(Week) + Endog + factor(Week) * Endog -1, id=ID, data=rdata, corstr="exchangeable"))
summary(geese(HamD ~ factor(Week) + Endog + factor(Week) * Endog -1, id=ID, data=rdata, corstr="independence"))
